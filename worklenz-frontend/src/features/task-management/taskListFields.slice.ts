...
const DEFAULT_FIELDS: TaskListField[] = [
  ...
  { key: 'TASK_TYPE', label: 'Type', visible: true, order: 5 },
  { key: 'ASSIGNEES', label: 'Assignees', visible: true, order: 6 },
  { key: 'LABELS', label: 'Labels', visible: true, order: 7 },
  { key: 'PHASE', label: 'Phase', visible: true, order: 8 },
  { key: 'PRIORITY', label: 'Priority', visible: true, order: 9 },
  { key: 'TIME_TRACKING', label: 'Time Tracking', visible: true, order: 10 },
  { key: 'ESTIMATION', label: 'Estimation', visible: false, order: 11 },
  { key: 'START_DATE', label: 'Start Date', visible: false, order: 12 },
  { key: 'DUE_DATE', label: 'Due Date', visible: true, order: 13 },
  { key: 'DUE_TIME', label: 'Due Time', visible: false, order: 14 },
  { key: 'COMPLETED_DATE', label: 'Completed Date', visible: false, order: 15 },
  { key: 'CREATED_DATE', label: 'Created Date', visible: false, order: 16 },
  { key: 'LAST_UPDATED', label: 'Last Updated', visible: false, order: 17 },
  { key: 'REPORTER', label: 'Reporter', visible: false, order: 18 },
];
